...
contract DeployBaseSepoliaScript is Script {
    string internal constant BASE_SEPOLIA_EXPLORER = "https://sepolia.basescan.org/tx/";
    ...
    function run() external {
        ...
        DynamicStableManagerHook hook =
            new DynamicStableManagerHook{salt: salt}(IPoolManager(poolManagerAddress), controller);
        ...
        console2.log("Explorer prefix", BASE_SEPOLIA_EXPLORER);
    }
}
